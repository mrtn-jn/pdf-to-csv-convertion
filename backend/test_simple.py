...
def test_basic_functionality():
    ...
    print(f"OK - Transaction structure: {transaction_data}")
    ...
    print("OK - Bank detection patterns working")
    ...
    print("OK - Transaction parsing patterns working")
    ...
    print("OK - Data cleaning working")
    ...
    print("OK - CSV format generation working")
    ...
    print("OK - API response format working")
